...
SPEC_FIELD_DEFS = [
    ...
    SpecField(key="background", label="故事背景",
              placeholder="时代背景、地理环境、核心地域、历史大事、传说（AI自动生成）...",
    ...
    SpecField(key="conflict_types", label="核心冲突类型",
              ...
              auto_fillable=True, multiline=True, order=8),
    SpecField(key="power_ceiling", label="力量上限",
              placeholder="实力天花板、超凡限制...",
              auto_fillable=True, multiline=False, order=9),
    ...
    SpecField(key="outline", label="全书大纲",
              ...
              auto_fillable=True, multiline=True, order=12),
]
